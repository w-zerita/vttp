...
public class UploadService {
    ...
    public static final String SQL_INSERT_BLOB = 
        "insert into post(title, media_type, pic) values (?, ?, ?)";
    ...
    public Integer upload(String title, MultipartFile myfile) throws IOException {
        return template.update(
            SQL_INSERT_BLOB, title, myfile.getContentType(), myfile.getInputStream());
    }
}
